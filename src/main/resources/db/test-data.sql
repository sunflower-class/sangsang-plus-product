-- Test data for Product Service (H2 Compatible)
-- 이 스크립트는 테스트 목적으로만 사용하세요

-- 테스트 상품 데이터 삽입 (H2 문법 사용)
INSERT INTO products (user_id, user_email, user_name, title, description, category, price, created_at, updated_at) VALUES
(1, 'user1@example.com', '사용자1', '맛있는 사과', '신선하고 달콤한 사과입니다.', '과일', 5000.00, DATEADD('DAY', -5, CURRENT_TIMESTAMP), DATEADD('DAY', -5, CURRENT_TIMESTAMP)),
(2, 'user2@example.com', '사용자2', '노트북 판매', '사용한지 1년된 노트북입니다.', '전자제품', 800000.00, DATEADD('DAY', -4, CURRENT_TIMESTAMP), DATEADD('DAY', -4, CURRENT_TIMESTAMP)),
(1, 'user1@example.com', '사용자1', '운동화', '거의 새 것 같은 운동화입니다.', '의류', 120000.00, DATEADD('DAY', -3, CURRENT_TIMESTAMP), DATEADD('DAY', -3, CURRENT_TIMESTAMP)),
(3, 'user3@example.com', '사용자3', '중고 책', '프로그래밍 관련 서적입니다.', '도서', 25000.00, DATEADD('DAY', -2, CURRENT_TIMESTAMP), DATEADD('DAY', -2, CURRENT_TIMESTAMP)),
(2, 'user2@example.com', '사용자2', '커피 원두', '갓 볶은 원두 커피입니다.', '식품', 15000.00, DATEADD('DAY', -1, CURRENT_TIMESTAMP), DATEADD('DAY', -1, CURRENT_TIMESTAMP)),
